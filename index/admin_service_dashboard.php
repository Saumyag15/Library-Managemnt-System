...
<!--Student Report Portion-->
 ...
 <!--ADD NEW BOOK-->           
            ...
            <div>Genre:<input type="radio" name="branch" value="Romantic"/>Romantic<input type="radio" name="branch" value="Friction"/>Friction<div style="margin-left:80px"><input type="radio" name="branch" value="Fantasy"/>Fantasy<input type="radio" name="branch" value="Historical"/>Historical</div>
            </div>   
